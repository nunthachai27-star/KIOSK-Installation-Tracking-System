...
export default async function StockProductPage({ params, searchParams }: {
  ...
  // Units cut out to fulfil a claim also leave the available pool.
  ...
  return (
    <div className="p-4 sm:p-6 max-w-[1160px] mx-auto flex flex-col gap-4">
      ...
      <div className={`grid gap-3 ${(borrowed > 0 ? 1 : 0) + (claimed > 0 ? 1 : 0) > 0 ? 'grid-cols-2 sm:grid-cols-4' : 'grid-cols-3'}`}>
        {[
