...
import { stockLevel, type ProductSummary, type LotSummary, type GroupSummary } from './stock-shared'

// re-export ของเดิม (types/const/stockLevel) เพื่อให้ที่ import จาก '@/lib/stock' เดิมใช้ได้เหมือนเดิม
